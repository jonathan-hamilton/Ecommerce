...
Product.create!(productName: "Product 4", description: "Description 4", price: 400.00, brand_id: 1, type_id: 1, category_id: 1)
Product.create!(productName: "Product 5", description: "Description 5", price: 500.00, brand_id: 2, type_id: 2, category_id: 2)
Product.create!(productName: "Product 6", description: "Description 6", price: 600.00, brand_id: 3, type_id: 3, category_id: 3)
