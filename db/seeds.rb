...
Product.create(productName: "Product 1", description: "Description 1", price: 100.00)
Product.create(productName: "Product 2", description: "Description 2", price: 200.00)
